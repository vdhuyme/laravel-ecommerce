                            ...
                            <div class="card-header border-bottom-dashed p-4">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <img src="{{ asset('admin/assets/images/logo-mail.png') }}" class="card-logo card-logo-dark"
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <h5 class="fs-14 mb-0"><span id="total-amount">{{ number_format($total+35000, 0, '.', '.') }} VNĐ</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                        ...
                                        @foreach ($orderProducts as $key => $product)
                                            <tr>
                                                ...
                                                <td>{{ number_format($product->purchasePrice, 0, '.', '.') }} VNĐ </td>
                                                <td>{{ $product->quantity }}</td>
                                                <td class="text-end">
                                                    {{ number_format($product->purchasePrice*$product->quantity, 0, '.', '.') }} VNĐ
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                ...
                                <div class="border-top border-top-dashed mt-2">
                                    <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto"
                                        ...
                                        <tr class="border-top border-top-dashed fs-15">
                                            ...
                                            <th class="text-end">{{ number_format($total+35000, 0, '.', '.') }} VNĐ</th>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    @if ($paymentMode === "cod")
                                        ...
                                        <p class="text-muted">Total Amount:
                                            <span id="card-total-amount">{{ number_format($total+35000, 0, '.', '.') }} VNĐ</span>
                                        </p>
                                    @else
                                        <p class="text-muted mb-1">Payment Method: <span class="fw-medium"
                                                                                         id="payment-method">Paypal</span></p>
                                        <p class="text-muted">Total Amount: <span class="fw-medium" id="">$</span><span
                                                    id="card-total-amount">{{ number_format(($total+35000)/23000, 2, '.', '') }}</span></p>
                                    @endif
                                </div>
                                <div class="mt-4">
