<div class="page-content">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Districts of list</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="d-flex justify-content-sm-end">
                                <div class="search-box ms-2">
                                    <input wire:model="searchTerm" type="text" class="form-control"
                                        id="searchProductList" placeholder="Search district...">
                        ...
                        <table class="table table-bordered align-middle table-nowrap mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Has Many Wards</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-medium">{{$district->id}}</td>
                                    <td>{{$district->firstName}} {{$district->districtName}}</td>
                                    <td>{{$district->province ->provinceName}}</td>
                                    <td>{{$district->wards->count()}}</td>
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a wire:click="editDistrict({{ $district->id }})" class="link-warning"
                                                style="cursor: pointer"><i class="ri-edit-2-line" data-bs-toggle="modal"
                                                    data-bs-target=".updateModal" data-bs-backdrop="static"></i></a>

                                            <a wire:click="deleteDistrict({{ $district->id }})" class="link-danger"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="storeModalCenter">NEW DISTRICT</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 form-label">
                                            ...
                                            <input type="text"
                                                class="form-control @error('districtName') is-invalid @enderror"
                                                id="districtName" placeholder="Enter name" wire:model.defer="districtName">

                                            @error('districtName') <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    <div wire:ignore.self class="modal fade updateModal" id="updateModal" tabindex="-1" data-bs-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalExtra">UPDATE DISTRICT</h5>
    ...
    <div wire:ignore.self class="modal fade zoomIn deleteModal" id="deleteModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="destroyDistrict">
