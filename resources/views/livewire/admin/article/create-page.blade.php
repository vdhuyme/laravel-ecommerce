                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="mb-3 form-label">
                                                        ...
                                                        FilePond.setOptions({
                                                            ...
                                                            server: {
                                                                process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
                                                                    @this.upload('articleImage', file, load, error, progress)
                                                                    
                                                                },
                                                                revert: (filename, load) => {
                                                                    @this.removeUpload('articleImage', filename, load)
                                                                },
                                                            },
                                                        });
                                                        ">
                                                        ...
                                                        @error('articleImage') <span class="text-danger">{{ $message
                                                            }}</span>
                                                        @enderror
                                                    </div>
