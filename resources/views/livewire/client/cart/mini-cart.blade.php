    ...
    <div class="cart-item-wrapper dropdown-sidemenu dropdown-hover-2">
        ...
        <div class="single-cart-item">
            ...
            <div class="cart-img">
                <a
                    href="{{route('productDetail', ['id' => $product->product->id, 'slug' => $product->product->productSlug])}}"><img
                        src="client/assets/images/default.png" alt=""></a>
            </div>
            @endif
            ...
            <div class="cart-text">
                ...
                <div class="cart-text-btn">
                    <div class="cart-qty">
                        ...
                        <span class="cart-price">{{number_format($product->product->sellingPrice, 0, '.',
                            '.')}} VNĐ</span>
                        <span class="old-price"><del>{{number_format($product->product->originalPrice, 0, '.',
                                '.')}} VNĐ</del></span>
                    </div>
                </div>
            </div>
