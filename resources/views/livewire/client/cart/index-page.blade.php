                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pro-thumbnail">
                                        ...
                                        <a
                                            href="{{route('productDetail', ['id' => $product->product->id, 'slug' => $product->product->productSlug])}}"><img
                                                class="img-fluid" src="client/assets/images/default.png"
                                                alt="Product" /></a>
                                        @endif
                                    </td>
                                    ...
                                    <td class="pro-price"><span>{{number_format($product->product->sellingPrice, 0, '.',
                                            '.')}} VNĐ </span> <span
                                            class="old-price"><del>{{number_format($product->product->originalPrice, 0,
                                                '.',
                                                '.')}} VNĐ</del></span></td>
                                    ...
                                    <td class="pro-subtotal">
                                        <span>{{number_format($product->product->sellingPrice*$product->quantity, 0,
                                            '.',
                                            '.')}} VNĐ</span>
                                    </td>
