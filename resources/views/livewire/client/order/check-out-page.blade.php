                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="cart-product-total text-center"><span
                                                class="amount"><strong>{{number_format($product->product->sellingPrice,
                                                    0, '.',
                                                    '.')}}</strong></span>
                                        </td>
                                        <td class="cart-product-total text-center"><span
                                                class="amount"><strong>{{number_format($product->product->sellingPrice*$product->quantity,
                                                    0, '.',
                                                    '.')}} VNĐ</strong></span>
                                        </td>
                                    </tr>
                                ...
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td class="text-center">
                                            <span class="amount"><strong>35.000
                                                    VNĐ</strong></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td class="text-center">
                                            <strong>
                                                <span class="amount">{{number_format($total+35000, 0, '.', '.')}}
                                                    VNĐ</span>
                                            </strong>
                                        </td>
                                    </tr>
