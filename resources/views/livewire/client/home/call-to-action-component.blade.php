                ...
                <div class="col-md-4 col-lg-4 col-custom">
                    <div class="call-to-action-item mt-0 d-lg-flex d-md-block align-items-center">
                        ...
                        <div class="call-to-action-info">
                            ...
                            <p class="desc-content">Giao hàng đúng hẹn, đủ hàng</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-custom">
                    <div class="call-to-action-item d-lg-flex d-md-block align-items-center">
                        ...
                        <div class="call-to-action-info">
                            ...
                            <p class="desc-content">Chúng tôi luôn đảm bảo chất lượng sản phẩm</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-custom">
                    <div class="call-to-action-item d-lg-flex d-md-block align-items-center">
                        ...
                        <div class="call-to-action-info">
                            ...
                            <p class="desc-content">Chúng tôi luôn đảm bảo chất lượng sản phẩm 24/7</p>
                        </div>
                    </div>
                </div>
            </div>
