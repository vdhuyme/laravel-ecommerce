...
<body>
    <div class="container">
        ...
        <div style="text-alain: center; display:flex; justify-content: center">
            <h1 style="font-size: calc(1.3rem + .6vw)">Ordered succeed,<br> Your order will be processed as soon as
                possible</h1>
        </div>
